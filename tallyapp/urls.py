...
urlpatterns = [
    ...
    path('subgroupsummary',views.subgroupsummary,name='subgroupsummary'),#groupledger ann
    path('ledgersummary',views.ledgersummary,name='ledgersummary'),#groupledger ann
